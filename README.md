...
HistoryMinerva 是注册到 HistoryVulcan 宿主的单一 CAD 转换模块。当前源码为 `4.4.3`。
...
| 模块清单权威源（当前 4.4.3） | [`b-Code-HistoryMinerva/module.manifest.json`](./b-Code-HistoryMinerva/module.manifest.json) |
